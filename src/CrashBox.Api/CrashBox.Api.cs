...
namespace CrashBox.Api
{
    public class CrashBoxApi
    {
        ...
        public static async Task<IActionResult> InsertCrash(
          [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "crash")] HttpRequest req,
          ...
          ILogger log)
        {
            try
            {
                ...
                crash.PKey = crash.App + "_" + crash.Version;
        ...
        public async Task<IActionResult> GetCrashes(
            ...
            ILogger log)
        {
            log.LogInformation("CrashBox: Test Jithesh Get Crashes Called...!!!!");
            _logger = log;
            try
            {
